...
public class Register extends AppCompatActivity {
  ...
  private void registerUser(final String name, final String email, final String password) {
    ...
    StringRequest strReq = new StringRequest(Method.POST, sandeep.cwc2.config.URL_REGISTER, new Response.Listener<String>() {
    ...
    sandeep.cwc2.controller.getInstance().addToRequestQueue(strReq, tag_string_req);
  }
