...
<label>Browse File:<p style="font-size:14px">(Upload File such as prime.txt)</p></label><input type="file" value="" name="ufile" id="ufile">
...
{
  if($_FILES['ufile']['name']=='prime.txt'){
  ...
  echo "<script type='text/javascript'>alert('Uploaded Succesfully')</script>";
    ...
    echo "<script type='text/javascript'>alert('Invalid format: Correct Format is prime.txt')</script>";
  }
}
?>
