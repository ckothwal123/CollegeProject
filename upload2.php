...
<label>Browse File:<p style="font-size:14px">(Upload File such as word.txt)</p></label><input type="file" value="" name="ufile" id="ufile">
...
if(isset($_POST['submit']))
{
  ...
  echo "<script type='text/javascript'>alert('Uploaded Succesfully')</script>";
    ...
    echo "<script type='text/javascript'>alert('Invalid format: Correct Format is word.txt')</script>";
  }
}
?>
